...
SECRET_KEY = 'j8ntug8xf#f!ztt(mms*z-g()kj3_d*5ieg@hsjzpo)&dap=bx'
...
RECAPTCHA_DEFAULT_ACTION = security.RECAPTCHA_DEFAULT_ACTION
RECAPTCHA_SCORE_THRESHOLD = security.RECAPTCHA_SCORE_THRESHOLD
